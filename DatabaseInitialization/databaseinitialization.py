...
class frmInitialize_dialog(QDialog, Ui_frmIntialize):
    ...
    def __init__(self, iface):
        ...
        self.cmdShapefile.clicked.connect(self.getText)
    ...
    def createSpatialTables(self):
        ...
        poleName = subcode+"_"+subcode+"_"+"pole"
        lineName = subcode+"_"+subcode+"_"+"line"
